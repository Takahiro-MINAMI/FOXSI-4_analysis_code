...
void peaktotxt_co()
{
  ...
  string infilename = "./Co57_single_sum.root";
  ...
  Int_t npeaks = 1;
  Int_t ave_width = 4;
  Double_t kev_ene[] = {14.4130};

  Int_t adc_start1[] = {100};
  Int_t adc_end1[] = {300};
  Int_t adc_start2[] = {100};
  Int_t adc_end2[] = {300};
  Int_t adc_start3[] = {100};
  Int_t adc_end3[] = {300};
  Int_t adc_start4[] = {100};
  Int_t adc_end4[] = {300};
  ...
  for (j = chmin; j < chmax + 1; ++j)
  {
    ...
    for (i = 0; i < npeaks; ++i)
    {
      ...
      // tmp_position = h1->GetBinCenter(h1->GetMaximumBin());
